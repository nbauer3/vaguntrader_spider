...
class PostsSpider(scrapy.Spider):
    ...
    #increment page number and append URL ?
    ...
    def parse(self, response):
        ...
        print '\n############### STARTING SPIDER ###############\n'
        for post in posts:
          #dont even need posts since not using it, just need simple for loop
       		...
       		# class date and time only exist for last posts past class new-alt-topictime & new-alt-topicsubject
